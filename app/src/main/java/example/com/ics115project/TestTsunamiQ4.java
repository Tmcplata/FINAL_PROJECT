...
public class TestTsunamiQ4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_tsunami_q4);
        ...
        A1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                AnsFinal.setText("An evacuation site is a safe haven for those affected by the disaster");
